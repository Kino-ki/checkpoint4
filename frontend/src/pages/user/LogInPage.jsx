    ...
    <div className=" border-redsanta flex-flex-col">
      ...
      >
        <input
          ...
          id="email"
          placeholder="EMAIL"
          className="rounded-xl shadow-sm shadow-greensanta lg:w-96  text-2xl lg:hover:w-[30rem] focus:w-[30rem] transition-all ease-in-out"
        />
        <input
          ref={passwordRef}
          type="password"
          id="password"
          className="rounded-xl shadow-sm shadow-greensanta lg:mt-0 lg:w-96 mt-10 text-2xl lg:hover:w-[30rem] focus:w-[30rem] transition-all ease-in-out"
        />
